...
const questions = [
    ...
    },
    {
        ...
        image: "\images\dolly_the_sheep.jpg",
...
function endGame() {
    ...
    const finalTime = document.getElementById('final-time'); // Get the final time element
    ...
    finalTime.textContent = `Time: ${formatTime(elapsedTime)}`; // Display the final time
